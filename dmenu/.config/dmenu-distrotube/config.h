...
#if PANGO_PATCH
static char font[] = "JetBrains Mono Nerd Font 15";
#else
#if XRESOURCES_PATCH
static char *fonts[] ="JetBrains Mono Nerd Font 15"
#else
static const char *fonts[] = 
#endif // XRESOURCES_PATCH
{
	"JetBrainsMonoNerdFont:pixelsize=15:antialias=true:autohint=true"
